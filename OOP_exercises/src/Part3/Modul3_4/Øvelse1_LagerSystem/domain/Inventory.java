...
import Part3.Modul3_4.Øvelse1_LagerSystem.data.FileBackend;
public class Inventory {
    ...
    public static void main (String args[]) {
        ...
        Item i2 = safeFoodItem("coffee", 24.95, new Date(52L * 365 * 1000 * 60 * 60 * 24));
        Item i3 = safeFoodItem("Milk", 12.95, new Date(12 * 1000 * 60 * 60 * 24));
        Item i4 = safeFoodItem("Egg", 4.95, new Date(0));
        Item i5 = new NonFoodItem("USB_Charger", 17.95, new String[] {"plastic", "stuff"});
